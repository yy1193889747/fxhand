	...
	<div class="gallery">
		<div class="container">
			<div class="gallery-grids">
				<c:forEach var="g" items="${p.list }">
					<div class="col-md-3 gallery-grid ">
						<a href="cygood!queryd.action?cygoods.cygid=${g.cygid }" onclick="return fun1()"><img
							src="upload/${g.cygphoto }" class="img-responsive" alt=""
							style="width:255px; height: 269px;" />
							<div class="gallery-info">
								<p>
									<span class="glyphicon glyphicon glyphicon-user"
										aria-hidden="true"></span> ${g.cyusers.cyuname }
								</p>
								<a class="shop" href="cygood!queryd.action?cygoods.cygid=${g.cygid }" onclick="return fun1()">查看详情</a>
							</div> </a>
						<div class="galy-info">
							<p>${g.cygtitle }</p>
							<div class="galry">
								<div class="prices">
									<h5 class="item_price">￥${g.cyprice }</h5>
								</div>
								<p>浏览次数 ：${g.cygview }</p>
							</div>
						</div>
