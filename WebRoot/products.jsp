		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					<li><a href="jump.jsp" class="active">首页</a></li>
	...
	<div class="gallery">
		<div class="container">
			...
			<div class="gallery-grids">
				<h2 style="margin-bottom: 20px">${glist[0].cyclassd.cyclassg.cgname }/${glist[0].cyclassd.cdname }</h2>	
				<c:forEach var="glist" items="${glist }">
				
					<div class="col-md-3 gallery-grid ">
						<a href="cygood!queryd.action?cygoods.cygid=${glist.cygid }" onclick="return fun1()"><img
							src="upload/${glist.cygphoto }" class="img-responsive" alt=""
							style="width:255px; height: 269px;" />
							<div class="gallery-info">
								<p>
									<span class="glyphicon glyphicon glyphicon-user"
										aria-hidden="true"></span> ${glist.cyusers.cyuname }
								</p>
								<a class="shop" href="cygood!queryd.action?cygoods.cygid=${glist.cygid }" onclick="return fun1()">查看详情</a>
							</div> </a>
						<div class="galy-info">
							<p>${glist.cygtitle }</p>
							<div class="galry">
								<div class="prices">
									<h5 class="item_price">￥${glist.cyprice }</h5>
								</div>
								<p>浏览次数 ：${glist.cygview }</p>
							</div>
						</div>
					</div>
				</c:forEach>
